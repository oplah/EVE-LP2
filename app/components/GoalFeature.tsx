...
const BULLETS = [
  "Clarify your personal growth goals in a guided conversation",
  "Discover quests and programs aligned to your path",
  "Get a curated roadmap built around your life",
  "Start seeing results in your first 30 days",
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="body text-gray-500 mb-8 max-w-lg">
              It can be hard to know where to begin. Goal AI asks you the right
              questions, helps you clarify what truly matters, and maps out a
              personalised learning path — so you&apos;re never left wondering
              what to do next.
            </p>
          ...
          <div className="flex justify-center lg:justify-end">
            <IPhoneFrame videoSrc="/goalAI.mp4" />
          </div>
